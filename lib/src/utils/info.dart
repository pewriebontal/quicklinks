...
const kSubtitle = 'powered by Kopi C Ice';
...
const kHomePageUrl = 'http://bontal.net';
const kBlogUrl = 'http://blog.bontal.net';
const kPortfolioUrl = 'http://portfolio.bontal.net';
const kTwitterUrl = 'http://twitter.com/pewriebontal';
const kInstagramUrl = 'http://instagram.com/pewriebontal';
const kLinkedinUrl = 'https://www.linkedin.com/in/pewriebontal';
const kTumblrUrl = 'http://tumblr.bontal.net';
...
const kCopyright = '© Pewrie Bontal - 2020-2023';
